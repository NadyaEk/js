...
let cartBlock = document.querySelector('.cart__block');
        ...
        let cartTotalPrice = document.querySelector(".cart__block_price");
        let cartBlockTotal = document.querySelector(".cart__block_total");

        let cart = {};
        document.querySelector('.product').addEventListener('click', event => {
            if (!event.target.offsetParent
            .classList.contains("product__button")) {
                return;
            }
        ...
        function renderProductInCart(id) {
            ...
            cartRowEl.querySelector('.cartCount')
                .textContent = cart[id].count;
        ...
        function renderNewProductInCart(productId) {
            ...
            <div class="cart__block_info cartCount">
                ${cart[productId].count}</div>
            <div class="cart__block_info">${cart[productId].price}</div>
            <div class="cart__block_info cartTotalPrice">
                ${cart[productId].count*cart[productId].price}</div>
            </div>
            `
